...
class Env(tk.Tk):
    ...
    def text_value(self, row, col, contents, action, font='Helvetica', size=10, color='black', style='normal', anchor="nw"):
        if action == 0:
    ...
    def print_value_all(self, q_table, samples_for_print):
        for i in self.texts:
            ...
            for y in range(WIDTH):
                ...
                for action in range(0, 4):
                    ...
                    if str(state) in q_table.keys():
                        ...
                        for sample_ in samples_for_print:
                            if x == sample_[0][0] and y == sample_[0][1] and action == sample_[1]:
                                isVisited = True
                        if isVisited:
                            self.text_value(y, x, round(temp, 2), action, color='red')
                        else:
                            self.text_value(y, x, round(temp, 2), action, color='black')
