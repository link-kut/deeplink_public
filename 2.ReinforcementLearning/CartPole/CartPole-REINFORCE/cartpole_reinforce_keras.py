...
class REINFORCEAgent:
    ...
    def build_model(self):
        ...
        # For the action taken, a, you set p_a = advantage. q_a is the output of the policy network, which is
    ...
    def train_model(self):
        ...
        self.model.fit(x=update_inputs, y=advantages, epochs=1, verbose=0)
        self.states, self.actions, self.rewards = [], [], []
