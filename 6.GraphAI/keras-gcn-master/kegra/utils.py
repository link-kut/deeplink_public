...
def load_data(path="data/cora/", dataset="cora"):
    ...
    adj = sp.coo_matrix(
        arg1=(np.ones(edges.shape[0]), (edges[:, 0], edges[:, 1])),
    ...
    print('Dataset has {} nodes, {} edges, {} features, {} labels.'.format(
        adj.shape[0], edges.shape[0], features.shape[1], labels.shape[1]
    ))
